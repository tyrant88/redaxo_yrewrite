...
// Nur nachfragen, wenn tatsächlich eine Datei überschrieben würde.
$htaccessAttributes = 'class="btn btn-primary"';
if (is_file(rex_path::frontend('.htaccess'))) {
    $htaccessAttributes = 'class="btn btn-primary yrewrite-copy-htaccess" data-confirm="' . rex_escape($this->i18n('htaccess_copy_confirm')) . '"';
}
...
$content = '
            ...
            <p><a ' . $htaccessAttributes . ' href="' . rex_url::currentBackendPage(['func' => 'htaccess'] + $csrf->getUrlParams()) . '">' . $this->i18n('yrewrite_htaccess_set') . '</a></p>
